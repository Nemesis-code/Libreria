...
public class ConsultarProveedores extends javax.swing.JFrame {
    ...
    private void pintarTabla(){
        ...
        DefaultTableModel t = new DefaultTableModel (encabezado,Libreria.proveedor.size());
        jTable1.setModel (t);
        TableModel tabla = jTable1.getModel();
        
        for (int i = 0; i < Libreria.proveedor.size(); i++) {
            Proveedores u = Libreria.proveedor.get(i);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (eliminar > 0) {
            if (JOptionPane.showConfirmDialog(this,"Estas seguro de eliminar")==0) {
                ...
                Libreria.proveedor.remove(eliminar);
                pintarTabla();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         if (jTable1.getSelectedRow()>= 0) {
            proveedor = Libreria.proveedor.get(jTable1.getSelectedRow());
